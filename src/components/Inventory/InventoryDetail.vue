            ...
            <el-row>
                ...
                <el-col :span="12">
                    <el-form-item label="频率">
                        <el-input v-model="form.frequency" disabled></el-input>
                    </el-form-item>
                </el-col>
            </el-row>
            <el-row>
                ...
                <el-col :span="12">
                    <el-form-item label="音调">
                        <el-input v-model="form.pitch" disabled></el-input>
                    </el-form-item>
                </el-col>
            </el-row>
            <el-row>
                <el-col :span="12">
                    <el-form-item label="颜色1">
                        <el-input v-model="form.color1" disabled></el-input>
                    </el-form-item>
                </el-col>
                <el-col :span="12">
                    <el-form-item label="颜色2">
                        <el-input v-model="form.color2" disabled></el-input>
                    </el-form-item>
                </el-col>
            </el-row>
            <el-row>
...
export default {
    ...
    mounted() {
        ...
        if (this && this.$route && this.$route.params && this.$route.params.id) {
            this.$post("/inventory/getInventoryList", { id: this.$route.params.id })
                .then((res) => {
                    this.code = res.code;
